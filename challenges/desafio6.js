...
//  a) Considerando todos os filmes que ganharam o Oscar pelo menos uma vez, calcule o maior
//  valor, menor valor, média e o desvio padrão das avaliações (campo imdb.rating)
//  b) Para a média e o desvio padrão arredonde os valores para uma casa decimal
//  utilizando o $round.
...
//  }
db.movies.aggregate([
  { $match: { awards: { $regex: /Won [1-9] Oscar/i } } },
  { $group: {
